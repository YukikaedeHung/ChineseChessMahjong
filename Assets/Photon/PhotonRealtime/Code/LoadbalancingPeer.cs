    ...
    public class LoadBalancingPeer : PhotonPeer
    {
        ...
        public virtual bool OpGetGameList(TypedLobby lobby, string queryData)
        {
            if (this.DebugOut >= DebugLevel.INFO)
            {
                ...
                Debug.Log("this.DebugOut >= DebugLevel.INFO");
            }
            ...
            if (lobby.Type != LobbyType.SqlLobby)
            {
                ...
                Debug.Log("lobby.Type != LobbyType.SqlLobby");
                return false;
            }
            ...
            if (lobby.IsDefault)
            {
                if (this.DebugOut >= DebugLevel.INFO)
                {
                    ...
                    Debug.Log("lobby.IsDefault - this.DebugOut >= DebugLevel.INFO");
                }
                Debug.Log("lobby.IsDefault");
                return false;
            }
            ...
            if (string.IsNullOrEmpty(queryData))
            {
                ...
                Debug.Log("string.IsNullOrEmpty(queryData)");
                return false;
            }
